...
class TestIdentityService(unittest.TestCase):
    def setUp(self):
        ...
        # Patch secrets
        self.patcher_secrets = patch(
            "streamlit.secrets", {"github_oauth": {"user_info_url": "https://api.github.com/user"}}
        )
    ...
    def test_sync_user_to_db_new_user(self, mock_get_session):
        ...
        user_info = {"id": 123, "login": "testuser", "name": "Test User"}
    ...
    def test_sync_user_to_db_existing_user(self, mock_get_session):
        ...
        user_info = {"id": 123, "login": "newname", "name": "New Name"}
    ...
    def test_fetch_github_user_info_authorized(self, mock_get):
        ...
        mock_teams.json.return_value = [{"slug": "proto-SNEA", "organization": {"login": "Brothertown-Language"}}]
