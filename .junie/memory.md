...
session_state: task=change-match status sync; fix=clear stale status_{row.id} before selectbox render when DB status diverges; file=upload_mdf.py:834-839; status=complete; GO=received
